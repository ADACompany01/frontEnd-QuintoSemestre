...
export default function SignUpClienteScreen({ navigation }) {
  const [form, setForm] = useState({ nome_completo: '', cnpj: '', email: '', telefone: '', senha: '' });
        ...
        <View style={styles.form}>
          ...
          <View style={styles.inputContainer}>
            ...
            <TextInput
              ...
              placeholderTextColor={theme.colors.text.muted}
              value={form.cnpj}
              onChangeText={(t) => onChange('cnpj', t)}
